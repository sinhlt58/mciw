package sinhblackgaming.mciw.entities;
...
public class ChanGioPigEntity extends AnimalEntity {
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.createKey(ChanGioPigEntity.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> BOOST_TIME = EntityDataManager.createKey(ChanGioPigEntity.class, DataSerializers.VARINT);
    private static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(ModItems.CHAN_GIO_SONG.get(), ModItems.CHAN_GIO_UOP.get(), ModItems.CHAN_GIO_CHIN.get());
    private boolean boosting;
    private int boostTime;
    private int totalBoostTime;

    public ChanGioPigEntity(EntityType<? extends ChanGioPigEntity> p_i50250_1_, World p_i50250_2_) {
    ...
    public ChanGioPigEntity createChild(AgeableEntity ageable) {
        return ModEntityTypes.CHAN_GIO_PIG.get().create(this.world);
    }
