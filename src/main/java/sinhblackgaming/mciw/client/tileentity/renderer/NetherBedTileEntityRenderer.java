package sinhblackgaming.mciw.client.tileentity.renderer;
...
@OnlyIn(Dist.CLIENT)
public class NetherBedTileEntityRenderer extends TileEntityRenderer<NetherBedTileEntity> {
    ...
    public NetherBedTileEntityRenderer(TileEntityRendererDispatcher p_i226006_1_) {
        super(p_i226006_1_);
    ...
    @Override
    public void func_225616_a_(NetherBedTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
        ...
        if (world != null) {
            ...
            TileEntityMerger.ICallbackWrapper<? extends NetherBedTileEntity> icallbackwrapper = TileEntityMerger.func_226924_a_(ModTileEntityTypes.NETHER_BED.get(), NetherBed::func_226863_i_, NetherBed::func_226862_h_, ChestBlock.FACING, blockstate, world, p_225616_1_.getPos(), (p_228846_0_, p_228846_1_) -> {
                return false;
            });
            int i = icallbackwrapper.apply(new DualBrightnessCallback<>()).get(p_225616_5_);
            this.func_228847_a_(p_225616_3_, p_225616_4_, blockstate.get(NetherBed.PART) == BedPart.HEAD, blockstate.get(NetherBed.HORIZONTAL_FACING), material, i, p_225616_6_, false);
        } else {
